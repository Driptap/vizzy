...
export function useSessionPersistence({
  ...
  const { prompts, opacities, muted, scales, sizes, positions, lights, layers, loops, bpm, fx, filters, aut, crossfade, cueScene, sourceTypes, decks } = state;
  useEffect(() => {
  ...
  }, [engineRef, prompts, opacities, muted, scales, sizes, positions, lights, layers, loops, bpm, fx, filters, aut, crossfade, cueScene, sourceTypes, decks]);
